    ...
    <main class="container mt-5">
        <div class="row">
            ...
            <div class="col-12 bg-dark p-3">
                <code>
                    <span class="text-secondary">//config.php</span> <br>
                    $host = "localhost:3306"; <br>
                    $database_name = "test"; <br>
                    $user = "root"; <span class="text-secondary">//Attention aux hackers</span> <br>
                    $password = "root"; <span class="text-secondary">//Attention aux hackers</span>
                </code>
            </div>
        </div>
    </main>
